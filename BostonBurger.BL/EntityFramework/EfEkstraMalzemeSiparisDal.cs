...
{
    public class EfEkstraMalzemeSiparisDal : GenericRepository<EkstraMalzemeSiparis>, IEkstraMalzemeSiparisDal
    {
        public EfEkstraMalzemeSiparisDal(UygulamaDbContext db) : base(db)
        {
        }
    }
}
